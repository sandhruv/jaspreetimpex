...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy of Jaspreet Impex - How we collect, use, and protect your personal information.",
};
      ...
      <section className="legal-section section">
        <div className="container">
          <div className="legal-content">
            ...
            <p>
              When you submit an inquiry through our contact forms, we collect the following
